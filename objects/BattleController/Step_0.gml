	...
	if (l49EEAEFD_0)
	{
		...
		else
		{
			...
			if(SelectedMoveEnemy == "SnackTime")
			{
				...
				/// @DnDInput : 2
				/// @DnDParent : 060AECD9
				/// @DnDArgument : "expr" ""The chef quickly took a break\nto have a snack. Bon appetit!""
				/// @DnDArgument : "expr_1" ""His strength was raised.""
				/// @DnDArgument : "var" "global.BattleTextOutput"
				/// @DnDArgument : "var_1" "SelectedMoveEnemy"
				global.BattleTextOutput = "The chef quickly took a break\nto have a snack. Bon appetit!";
			...
			if(SelectedMoveEnemy == "SpatulaSlap")
			{
				...
				/// @DnDInput : 2
				/// @DnDParent : 4A562481
				/// @DnDArgument : "expr" ""The chef whapped you with a\nspatula, nearly flipping you in\nthe process.""
				/// @DnDArgument : "expr_1" ""You took " + string(1*(15 * (1+(2*global.EnemyATK / 10))) div 1) + " damage""
				/// @DnDArgument : "var" "global.BattleTextOutput"
				/// @DnDArgument : "var_1" "SelectedMoveEnemy"
				global.BattleTextOutput = "The chef whapped you with a\nspatula, nearly flipping you in\nthe process.";
				SelectedMoveEnemy = "You took " + string(1*(15 * (1+(2*global.EnemyATK / 10))) div 1) + " damage";
			...
			if(SelectedMoveEnemy == "BoilingWater")
			{
				...
				/// @DnDInput : 2
				/// @DnDParent : 63468226
				/// @DnDArgument : "expr" ""The chef pours a pot of boiling\nwater over you. Did he salt it\nfirst?""
				/// @DnDArgument : "expr_1" ""You took " + string(1*(15 * (1+(2*global.EnemyATK / 10))) div 1) + " damage""
				/// @DnDArgument : "var" "global.BattleTextOutput"
				/// @DnDArgument : "var_1" "SelectedMoveEnemy"
				global.BattleTextOutput = "The chef pours a pot of boiling\nwater over you. Did he salt it\nfirst?";
				SelectedMoveEnemy = "You took " + string(1*(15 * (1+(2*global.EnemyATK / 10))) div 1) + " damage";
...
if(global.BattleStep == 2)
{
	...
	if (l515E38B9_0)
	{
		...
		/// @DnDArgument : "soundid" "global.BattleMusic"
		/// @DnDArgument : "loop" "1"
		audio_play_sound(global.BattleMusic, 0, 1, 1.0, undefined, 1.0);
	}
}
