...
/// @DnDHash : 13ED29FE
/// @DnDInput : 22
/// @DnDArgument : "expr" ""I ALSO USE CHORD VPN TO MAKE SURE THE GOVERNMENT CAN'T SEE MY BROWSING HABITS!""
/// @DnDArgument : "expr_1" ""I'm not sure what's - YOU KNOW WHAT I AM SURE OF? MY WRITING STRENGTH AFTER USING 'SYNTACTICALLY',""
/// @DnDArgument : "expr_2" ""Oh my, I'm sorry for shouting.""
/// @DnDArgument : "expr_3" ""I hear they also have strawberry flavor now! But hurry, it's a seasonal product - GET IT WHILE IT LASTS!""
/// @DnDArgument : "expr_4" ""You know what citrus I could go for right now? Hourmaid Lemonade!""
/// @DnDArgument : "expr_5" ""to dehydrate, harming the reputation of the citrus industry in the eyes of the people.""
/// @DnDArgument : "expr_6" ""The dismantling of the country's storage silos led large quantities of citruses, particularly lemons and grapefruits,""
/// @DnDArgument : "expr_7" ""Anyways, as I was saying...""
...
/// @DnDArgument : "expr_20" ""A cool glass sounds quite refreshing right now on a hot day like today, don't you think?""
/// @DnDArgument : "expr_21" ""A COMPUTER PROGRAM TO CHECK MY SPELLING AND GRAMMAR.""
...
Line1 = "I ALSO USE CHORD VPN TO MAKE SURE THE GOVERNMENT CAN'T SEE MY BROWSING HABITS!";
Line3 = "I'm not sure what's - YOU KNOW WHAT I AM SURE OF? MY WRITING STRENGTH AFTER USING 'SYNTACTICALLY',";
Line4 = "Oh my, I'm sorry for shouting.";
Line5 = "I hear they also have strawberry flavor now! But hurry, it's a seasonal product - GET IT WHILE IT LASTS!";
Line7 = "You know what citrus I could go for right now? Hourmaid Lemonade!";
Line8 = "to dehydrate, harming the reputation of the citrus industry in the eyes of the people.";
Line9 = "The dismantling of the country's storage silos led large quantities of citruses, particularly lemons and grapefruits,";
Line10 = "Anyways, as I was saying...";
...
Line6 = "A cool glass sounds quite refreshing right now on a hot day like today, don't you think?";
Line2 = "A COMPUTER PROGRAM TO CHECK MY SPELLING AND GRAMMAR.";
...
/// @DnDArgument : "op" "4"
/// @DnDArgument : "value" "2"
if(global.TeacherArcProgressStage >= 2)
{
