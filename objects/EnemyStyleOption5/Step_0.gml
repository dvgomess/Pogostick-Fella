...
if(global.GodmodeSelectedButton == 7)
{
	...
	/// @DnDArgument : "value" "principal"
	if(global.EnemyStyle == principal)
	{
		...
		/// @DnDArgument : "spriteind" "sEnemyStyle5"
		/// @DnDSaveInfo : "spriteind" "sEnemyStyle5"
		sprite_index = sEnemyStyle5;
		image_index = 1;
	}
