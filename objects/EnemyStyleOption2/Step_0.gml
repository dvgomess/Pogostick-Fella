...
if(global.GodmodeSelectedButton == 7)
{
	...
	/// @DnDArgument : "value" "sBattleDummy"
	if(global.EnemyStyle == sBattleDummy)
	{
		...
		/// @DnDArgument : "spriteind" "sEnemyStyle2"
		/// @DnDSaveInfo : "spriteind" "sEnemyStyle2"
		sprite_index = sEnemyStyle2;
		image_index = 1;
	}
