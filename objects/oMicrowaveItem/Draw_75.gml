...
if(InDialogue == 1)
{
	...
	if(LineCount == 1)
	{
		...
		draw_text_transformed(220, 480, "" + string(string_copy(Line1,1,DrawTextScroll)), 2, 2, 0);
	...
	if(LineCount == 2)
	{
		...
		if(DrawTextScroll < string_length(Line2))
		{
			...
			if (!audio_is_playing(l5BAE5893_0))
			{
				...
				/// @DnDArgument : "min" "1.2"
				/// @DnDArgument : "max" "1.2"
				RandomPitch = (random_range(1.2, 1.2));
	...
	if(LineCount == 5)
	{
		...
		if(DrawTextScroll < string_length(Line5))
		{
			...
			if (!audio_is_playing(l18D42CE4_0))
			{
				...
				/// @DnDArgument : "min" ".95"
				/// @DnDArgument : "max" "1.2"
				RandomPitch = (random_range(.95, 1.2));
