...
if(global.InBattleDrawText == 1)
{
	...
	draw_sprite_ext(DialogueBoxBattle, 0, 320, 288, 2, 2, 0, $FFFFFF & $ffffff, 1);
	...
	draw_text_transformed(140, 246, string("") + string(string_copy(global.BattleTextOutput,1,global.BattleTextOutputCharacterVal)), 1, 1, 0);
}